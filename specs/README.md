...
| 002 | [papers-ingest-full](002-papers-ingest-full/spec.draft.md) | ⏸ 001完了待ち | Embeddingモデルは決定(Qwen3-Embedding-0.6B、ローカルGPU)。ストレージ(SQLite/Postgres)は未決定、001が動いてから決める |
