...
- 「日記モードになって」「日記モード終了」のような、日記モードの開始/終了を指示する
  発話そのものや、それに対するアシスタントの定型応答(「日記モードを開始しました。
  今日あったことを話してください。」等)は、その日の出来事ではありません。日記本文には
  含めず、無視してください。同じ断片の中に実際の出来事の内容が含まれていれば、
  そちらだけを日記として採用してください
"""
